...
class ExampleColorsThemeDefault {
  ...
  final Color componentCardDefaultActionSubtle;
   ...
   ExampleColorsThemeDefault({
    ...
    Color? componentTabbarBg,
    Color? componentTabbarTabActive,
    Color? componentTabbarTabInactive,
    Color? componentCardHighlightBg,
    Color? componentCardHighlightBorder,
    Color? componentCardHighlightTextDefault,
    Color? componentCardHighlightTextSubtle,
    Color? componentCardHighlightActionSubtle,
    Color? componentCardDefaultBg,
    Color? componentCardDefaultBorder,
    Color? componentCardDefaultTextDefault,
    Color? componentCardDefaultTextSubtle,
    Color? componentCardDefaultActionSubtle,
